...
static std::vector<std::string> s_Preset_print_options {
    ...
    "extruder_clearance_height", "gcode_comments", "errors_are_warnings", "gcode_label_objects", "output_filename_format", "post_process", "gcode_substitutions", "gcode_binary", "perimeter_extruder",
